    ...
    <v-col class="text-center" cols="12">
      ...
      >
        <template slot="prepend">
          <v-select 
            solo hide-details dense flat
            :height="selectSetting.height"
            :items="selectSetting.items"
            :style="selectSetting.style">
          </v-select>
          <!-- <v-menu>
...
export default {
  ...
  data: () => ({
    ...
    selectSetting: {
      ...
      style: {
        ...
        width: '120px',
        top: '-12px',
        left: '30px',        border: '1px grey solid', 
        'z-index': '999',      
      }
    }
  }),
  ...
  methods: {
      // text-field의 높이를 구한다.
    matchHeight() {
      const height = this.$refs.textField.$el.clientHeight -8 + 'px'
      this.selectSetting.height = height
      console.log(height)
    },
